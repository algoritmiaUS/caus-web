...
<section class="lg:pb-24">
  <div class="max-w-(--breakpoint-md) px-4 mx-auto">
       <p class="mb-8 font-light text-center text-gray-500 lg:mb-16 dark:text-gray-400 sm:text-xl">
        ...
        <br><br>
        If you are a student and wish to participate actively, we invite you to join our <a href="https://chat.whatsapp.com/DFm3DnLHbGn4vWimWN1Wmc" class="text-indigo-600 hover:underline">Whatsapp</a> server. There you will find an inclusive and friendly community, made up of both current students and alumni.
      </p>
