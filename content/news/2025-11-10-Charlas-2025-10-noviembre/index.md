...
summary: Charlas y talleres organizados por el CAUS en noviembre de 2025. Se trata de ponencias sobre informática tanto de profesionales como de estudiantes.
...
<div class="space-y-6 dark:bg-gray-900 dark:text-gray-100">
  <div class="border border-gray-200 rounded-lg p-4 md:p-6 bg-white shadow-xs dark:bg-gray-800 dark:border-gray-700">
    <h2 class="text-lg font-semibold text-gray-800 dark:text-white">Los algoritmos de un monoplaza autónomo de Formula Student</h2>
    <div class="mt-4 text-gray-600 dark:text-gray-300 space-y-2">
      <div class="flex items-center space-x-2">
        ...
        <span class="text-sm md:text-base">Jueves, 13 de noviembre de 2025</span>
      </div>
      <div class="flex items-center space-x-2">
      ...
      <p class="mt-4 text-sm md:text-base text-gray-500 dark:text-gray-400">
        <strong>Ponente:</strong> José Manuel Landero e Ignacio Sánchez
      </p>
      <p class="text-sm md:text-base text-gray-500 dark:text-gray-400">
        <strong>Descripción:</strong> José Manuel Landero e Ignacio Sánchez
